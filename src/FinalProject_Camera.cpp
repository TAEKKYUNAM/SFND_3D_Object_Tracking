...
int main(int argc, const char *argv[])
{
    ...
    vector<int> match_F ;
    vector<float> det_time;
    vector<float> desc_time;
    vector<int> FINAL;
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            if (descriptorType.compare("SIFT") == 0) descriptorTypeForMatch = "DES_HOG";
     ...
     for (int i = 0; i< TTC_Camera.size() ; ++i)
    {
        ...
        cout<< TTC_Camera[i] <<endl;
    }

    cout <<"Lidar TTC: " <<endl;

    for (int i = 0; i<TTC_Lidar.size() ; ++i)
    {
        // cout <<"CAMERA Lidar : " <<endl;
        cout<< TTC_Lidar[i] <<endl;
    }
